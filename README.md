...
1. Taxonomic composition (total & active communities)

2. Functional potential (DNA)

3. Functional activity (RNA)
...
**Here I am discussing Kaiju Classification and visulization**
Please see below for more deatails:
📂 Folder: day02_kaiju/
✍️ Blog:https://jojyjohn28.github.io/blog/size-fractionated-microbiome-analysis-day2/

#### ✅ Day 3 — Species-Level Profiling with mOTUs

**Here I am exploring total community diversity using mOTUs.**
Please see below for more deatails:
...
#### Day 5 -Substrate Uptake & Utilization Analysis- Broad level from metagenome
...
#### Day 6 Co-occurrence networks (season, bay, fraction)
...
📂 Folder:day06_co-occurance_network
✍️ Blog: https://jojyjohn28.github.io/blog/cooccurrence-network-genome-data/

#### Day 7 -Substrate Uptake & Utilization Analysis\_ from retrieved genome (2000)

This post documents an ongoing analysis of 1,824 representative estuarine genomes — annotating their carbohydrate-active enzymes (CAZymes) with dbCAN and their transport systems with the TCDB database, then linking those functional profiles to observed free-living (FL) vs particle-associated (PA) abundance patterns.
